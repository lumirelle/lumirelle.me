...
projects:
  ...
  Starters:
    - name: 'TypeScript'
      link: 'https://github.com/lumirelle/starter-ts'
      desc: 'TypeScript library starter.'
      icon: 'i-vscode-icons-file-type-tsconfig'
    - name: 'TypeScript Monorepo'
      link: 'https://github.com/lumirelle/starter-ts-monorepo'
      desc: 'TypeScript Monorepo starter.'
      icon: 'i-vscode-icons-file-type-webpack'
    - name: 'Nuxt'
      link: 'https://github.com/lumirelle/starter-nuxt'
      desc: 'Starter template for Nuxt 4 🏔💚⚡️'
